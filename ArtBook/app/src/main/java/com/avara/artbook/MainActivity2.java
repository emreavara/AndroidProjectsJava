...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(info.matches("new")){
            ...
            Bitmap defaultImage = BitmapFactory.decodeResource(getApplicationContext().getResources(), R.drawable.selectimage);
            selectImageView.setImageBitmap(defaultImage);
            ...
            try {
                ...
                while(cursor.moveToNext()){
                    ...
                    painterNameText.setText(cursor.getString(painterIndex));
